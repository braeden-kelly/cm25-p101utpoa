...
if(!(test-path C:\scripts\CodeMash25\files)){New-Item -Path C:\Scripts\CodeMash25\ -name files -ItemType Directory}

if((test-path C:\scripts\CodeMash25\files) -eq $false){New-Item -Path C:\Scripts\CodeMash25\ -name files -ItemType Directory}
...
1..10 | ForEach-Object {new-item -ItemType File -name "$_.md"}
Get-ChildItem -Path C:\Scripts\CodeMash25 | Select-Object name | ForEach-Object { write-output $_ }

$planets = "Earth","Mars",'Saturn',
$planets | ForEach-Object {new-item -ItemType File -name "$_.md"}

$files = Get-ChildItem -path C:\Scripts\CodeMash25 | Select-Object Name
...
$folder = 'C:\scripts\CodeMash25\files'
